...
public interface IFile {
    ...
    <T extends  BaseRequest> FileResponse renameTo(Context context, T srcRequest, T destRequest);
    <T extends  BaseRequest> FileResponse renameTo(Context context, T wrapperRequest);
